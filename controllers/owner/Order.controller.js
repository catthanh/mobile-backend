            ...
            switch(statusToChange) {
                case STATUS.CONFIRMED:
                    if(order?.status === STATUS.PENDING) {
                        ...
                        next(createError.BadRequest('order must be pending before switch to confirmed'));
                    }
                case STATUS.PREPARING:
                    if(order?.status === STATUS.CONFIRMED) {
                        ...
                        next(createError.BadRequest('you must confirm order before switch to preparing step'));
                    }
                case STATUS.DELIVERING:
                    if(order?.status === STATUS.PREPARING) {
                        ...
                        next(createError.BadRequest('you must complete preparing order before switch to delivering step'));
                    }
                default:
